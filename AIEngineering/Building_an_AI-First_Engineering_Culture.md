...
I practice what I preach. I've shipped a half-dozen YOLO tools that our engineering and business teams actually use, now consolidated into [DocForge AI](https://bordenet.github.io/docforge-ai/): [One-Pager](https://bordenet.github.io/docforge-ai/assistant/?type=one-pager), [PR-FAQ](https://bordenet.github.io/docforge-ai/assistant/?type=pr-faq), [ADR](https://bordenet.github.io/docforge-ai/assistant/?type=adr), [Strategic Proposal](https://bordenet.github.io/docforge-ai/assistant/?type=strategic-proposal), and [Power Statement](https://bordenet.github.io/docforge-ai/assistant/?type=power-statement). Through near brute-force continuous improvement, the code quality no longer sucks. But it started scrappy, and that was fine. They removed toil from day one.
