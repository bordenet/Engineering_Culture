...
| **19% slower** on complex tasks for experienced developers, despite perceiving speedups | [METR study via Ars Technica](https://arstechnica.com/ai/2025/07/study-finds-ai-tools-made-open-source-software-developers-19-percent-slower/) |
